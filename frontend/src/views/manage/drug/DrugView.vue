<template>
  <a-modal v-model="show" title="疫苗详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="drugData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">疫苗信息</span></a-col>
        <a-col :span="8"><b>疫苗名称：</b>
          {{ drugData.name }}
        </a-col>
        <a-col :span="8"><b>疫苗编号：</b>
          {{ drugData.code }}
        </a-col>
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>疫苗类别：</b>
          ...
          <span v-if="drugData.classification == 6">生化疫苗</span>
          <span v-if="drugData.classification == 7">放射性疫苗</span>
          <span v-if="drugData.classification == 8">血清</span>
          <span v-if="drugData.classification == 9">诊断疫苗</span>
        </a-col>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">疫苗图片</span></a-col>
        <a-col :span="24">
          <a-upload
            name="avatar"
