<template>
  <a-modal v-model="show" title="疫苗商家详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="pharmacyData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">疫苗商家信息</span></a-col>
        <a-col :span="8"><b>疫苗商家名称：</b>
          {{ pharmacyData.name }}
        </a-col>
        <a-col :span="8"><b>疫苗商家编号：</b>
          {{ pharmacyData.code }}
        </a-col>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">疫苗商家图片</span></a-col>
        <a-col :span="24">
          <a-upload
            name="avatar"
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 5px"><span style="font-size: 15px;font-weight: 650;color: #000c17">疫苗商家位置</span></a-col>
      </a-row>
      <div>
